...
3. Adicione o remote upstream para manter seu repositório local atualizado: git remote add upstream
https://github.com/elidianaandrade/dio-lab-open-source.git:
Utilize o comando git pull upstream na para baixar e mesclar as alterações no seu repositório local com base na branch nade deste repcsitório original de onde você fez o fork, ou git fetch upstrewe ate para baixar sem mesclar. Veja mais em:
Primeiros Passos com Git GitHub.
4. Crie uma nova branch e nomeie como feat/community/seunomedeusuario: git checkout -b feat/community/seuromedeusuario:
Exemplo: git checkout heat/community/elitiansandrate
5. Dentro da pasta, crie um arquivo em Markdown (extensão) e nomeie com o mesmo nome do seu usuário no GitHub Exemploc elitianaandrade, nd
6. Desenvolva o seu perfil. Para isso, você pode ver exemplos na pastaty e adicionar alguns dos utilitários presentes na pasta
Observação: Use os outros exemplos como inspiração e não cópia
7. Adicione suas alterações à "staging area" com o comando git add community/seunamedeusuarto.nd:
8. Crie um commit e adicione a mensagem indicando a adição do seu perfil git commit "feat: add seunosedeusuario profile":
9. Envie as alterações para o seu repositório remoto git push origin feat/community/seunosedrusuario:
